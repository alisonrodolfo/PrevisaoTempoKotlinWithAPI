...
class TasksActivityTest {
    ...
    @Test
    fun editTask() {
        repository.saveTaskBlocking(Cidades("TITLE1", "DESCRIPTION"))
    ...
    fun createTwoTasks_deleteOneTask() {
        repository.saveTaskBlocking(Cidades("TITLE1", "DESCRIPTION"))
        repository.saveTaskBlocking(Cidades("TITLE2", "DESCRIPTION"))
    ...
    fun markTaskAsCompleteOnDetailScreen_taskIsCompleteInList() {
        ...
        repository.saveTaskBlocking(Cidades(taskTitle, "DESCRIPTION"))
    ...
    fun markTaskAsActiveOnDetailScreen_taskIsActiveInList() {
        ...
        repository.saveTaskBlocking(Cidades(taskTitle, "DESCRIPTION", true))
