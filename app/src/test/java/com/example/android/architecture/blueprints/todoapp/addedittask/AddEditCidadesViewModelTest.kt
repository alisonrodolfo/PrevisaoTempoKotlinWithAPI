...
class AddEditCidadesViewModelTest {
    ...
    private val task = Cidades("Title1", "Description1")
    ...
    private fun saveTaskAndAssertSnackbarError(title: String?, description: String?) {
        ...
        assertSnackbarMessage(addEditTaskViewModel.snackbarText, string.empty_cidade_message)
    }
}
