...
import com.example.android.architecture.blueprints.todoapp.data.source.DefaultCidadesRepository
...
class StatisticsViewModelTest {
    ...
    fun loadNonEmptyTasksFromRepository_NonEmptyResults() {
        ...
        val task4 = Cidades("Title4", "Description4", true)
