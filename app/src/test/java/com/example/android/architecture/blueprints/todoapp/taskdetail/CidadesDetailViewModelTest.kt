...
class CidadesDetailViewModelTest {
    ...
    val task = Cidades("Title1", "Description1")
    ...
    fun getActiveTaskFromRepositoryAndLoadIntoView() {
        ...
        assertThat(taskDetailViewModel.cidades.getOrAwaitValue()?.title).isEqualTo(task.title)
        assertThat(taskDetailViewModel.cidades.getOrAwaitValue()?.description)
    ...
    fun completeTask() {
        ...
        taskDetailViewModel.cidades.getOrAwaitValue()
    ...
    fun activateTask() {
        ...
        taskDetailViewModel.start(task.id)
        // Start observing to compute transformations
        taskDetailViewModel.cidades.observeForTesting {
