...
class TasksViewModelTest {
    ...
    fun setupViewModel() {
        ...
        val task1 = Cidades("Title1", "Description1")
        val task2 = Cidades("Title2", "Description2", true)
        val task3 = Cidades("Title3", "Description3", true)
    ...
    fun loadAllTasksFromRepository_loadingTogglesAndDataLoaded() {
        ...
        tasksViewModel.setFiltering(TempoFilterType.ALL_TASKS)
    ...
    fun loadActiveTasksFromRepositoryAndLoadIntoView() {
        // Given an initialized TasksViewModel with initialized tasks
        // When loading of Tasks is requested
        tasksViewModel.setFiltering(TempoFilterType.ACTIVE_TASKS)
    ...
    fun loadCompletedTasksFromRepositoryAndLoadIntoView() {
        // Given an initialized TasksViewModel with initialized tasks
        // When loading of Tasks is requested
        tasksViewModel.setFiltering(TempoFilterType.COMPLETED_TASKS)
    ...
    fun loadTasks_error() {
        ...
        tasksViewModel.items.observeForTesting {
            ...
            assertSnackbarMessage(tasksViewModel.snackbarText, R.string.loading_cidade_error)
        }
    }
    ...
    fun showEditResultMessages_editOk_snackbarUpdated() {
        ...
        assertSnackbarMessage(
            tasksViewModel.snackbarText, R.string.successfully_saved_cidade_message
        )
    }
    ...
    fun showEditResultMessages_addOk_snackbarUpdated() {
        ...
        // The snackbar is updated
        assertSnackbarMessage(
            tasksViewModel.snackbarText, R.string.successfully_added_cidade_message
        )
    }
    ...
    fun showEditResultMessages_deleteOk_snackbarUpdated() {
        ...
        // The snackbar is updated
        assertSnackbarMessage(tasksViewModel.snackbarText, R.string.successfully_deleted_cidade_message)
    }

    @Test
    fun completeTask_dataAndSnackbarUpdated() {
        // With a repository that has an active task
        val task = Cidades("Title", "Description")
    ...
    fun activateTask_dataAndSnackbarUpdated() {
        ...
        val task = Cidades("Title", "Description", true)
        tasksRepository.addTasks(task)
