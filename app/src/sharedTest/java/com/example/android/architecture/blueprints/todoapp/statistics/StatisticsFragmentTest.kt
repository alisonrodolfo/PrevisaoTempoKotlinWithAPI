...
class StatisticsFragmentTest {
    ...
    fun tasks_showsNonEmptyMessage() {
        // Given some tasks
        repository.apply {
            saveTaskBlocking(Cidades("Title1", "Description1", false))
            saveTaskBlocking(Cidades("Title2", "Description2", true))
        }
        ...
        val expectedActiveTaskText = getApplicationContext<Context>()
            .getString(R.string.statistics_active_cidade, 50.0f)
        val expectedCompletedTaskText = getApplicationContext<Context>()
            .getString(R.string.statistics_completed_cidade, 50.0f)
