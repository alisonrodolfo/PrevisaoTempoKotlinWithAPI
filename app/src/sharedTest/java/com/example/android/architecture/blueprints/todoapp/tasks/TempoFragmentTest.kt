...
class TempoFragmentTest {
    ...
    fun displayTask_whenRepositoryHasData() {
        ...
        repository.saveTaskBlocking(Cidades("TITLE1", "DESCRIPTION1"))
    ...
    fun displayCompletedTask() {
        repository.saveTaskBlocking(Cidades("TITLE1", "DESCRIPTION1", true))
    ...
    fun deleteOneOfTwoTasks() {
        repository.saveTaskBlocking(Cidades("TITLE1", "DESCRIPTION1"))
        repository.saveTaskBlocking(Cidades("TITLE2", "DESCRIPTION2"))
    ...
    fun showAllTasks() {
        ...
        repository.saveTaskBlocking(Cidades("TITLE1", "DESCRIPTION1"))
        repository.saveTaskBlocking(Cidades("TITLE2", "DESCRIPTION2", true))
    ...
    fun showActiveTasks() {
        ...
        repository.saveTaskBlocking(Cidades("TITLE1", "DESCRIPTION1"))
        repository.saveTaskBlocking(Cidades("TITLE2", "DESCRIPTION2"))
        repository.saveTaskBlocking(Cidades("TITLE3", "DESCRIPTION3", true))
    ...
    fun clickAddTaskButton_navigateToAddEditFragment() {
        ...
        val scenario = launchFragmentInContainer<TempoFragment>(Bundle(), R.style.AppTheme)
        ...
        verify(navController).navigate(
                TempoFragmentDirections.actionTasksFragmentToAddEditTaskFragment(
                null, getApplicationContext<Context>().getString(R.string.add_cidade)
            )
        )
    }
