...
class TasksDaoTest {
    ...
    fun insertTaskAndGetById() = runBlockingTest {
        ...
        assertThat<Cidades>(loaded as Cidades, notNullValue())
    ...
    fun insertTaskReplacesOnConflict() = runBlockingTest {
        ...
        val newTask = Cidades("title2", "description2", true, task.id)
    ...
    fun updateTaskAndGetById() = runBlockingTest {
        ...
        val originalTask = Cidades("title", "description")
        database.taskDao().insertTask(originalTask)

        // When the task is updated
        val updatedTask = Cidades("new title", "new description", true, originalTask.id)
    ...
    fun deleteTasksAndGettingTasks() = runBlockingTest {
        // Given a task inserted
        database.taskDao().insertTask(Cidades("title", "description"))
    ...
    fun deleteCompletedTasksAndGettingTasks() = runBlockingTest {
        ...
        database.taskDao().insertTask(Cidades("completed", "task", true))
